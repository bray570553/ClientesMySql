...
public class Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItemRegistrarCliente.setText("Register");
        ...
        jMenu_Clients.add(jMenuItemRegistrarCliente);
    ...
    private void jMenuItemRegistrarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemRegistrarClienteActionPerformed
        JIFClientGUI cliJIF = new JIFClientGUI();
        jDesktopPanePrincipal.removeAll();
        jDesktopPanePrincipal.add(cliJIF);
        cliJIF.show();
